...
export const Props = () => {
  ...
  const personas =[
    { id: 1, nombre: 'Katsuko Saruhashi', img: '/Taller2-React/images/Katsuko.png', tamaño: '150px' },
    { id: 2, nombre: 'Aklilu Lemma', img: '/Taller2-React/images/Aklilu.png', tamaño: '120px' },
    { id: 3, nombre: 'Lin Lanying', img: '/Taller2-React/images/Lin.png', tamaño: '100px' },
  ]
